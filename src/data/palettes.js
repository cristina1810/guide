// Paletas de color. Cada paleta tiene variantes light + dark. La función
...
export const PALETTES = {
  mono: {
    ...
    light: {
      ...
      "--sidebar-bg": "#09173a",
      "--sidebar-text": "#dce6f9",
      "--sidebar-muted": "#6e88b4",
      "--sidebar-border": "#162d5a",
...
export function applyPalette(name, mode = "light") {
