      ...
      <div
        ...
        ${
          checked
            ...
            : "ring-gray-300 dark:ring-zinc-600 after:bg-gray-300 dark:after:bg-zinc-500"
        }`}
      />
    </label>
  );
