      ...
      <div className="flex flex-1">
        ...
        <div className="w-80 shrink-0 px-4 py-5">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <MainButton className="px-2 py-1 text-xs">
              <Plus size={14} />
              Add Rule
            </MainButton>
          </div>
...
const VARS_DATA = [
  ...
  },
  {
    ...
    type: "UDO Variable",
    destination: "ADD_CART.item_category",
    destColor: "orange",
  },
  {
    id: 4,
    ...
    type: "UDO Variable",
    destination: "ADD_CART.number_items",
    destColor: "orange",
  },
  {
    id: 5,
    ...
    type: "UDO Variable",
    destination: "add_to_cartADD_CART",
    destColor: "blue",
  },
  {
    id: 6,
    variable: "search_event",
    type: "UDO Variable",
  ...
  {
    id: 7,
    variable: "site_currency",
    type: "UDO Variable",
    destination: "ADD_CART.currency",
    destColor: "orange",
  },
  {
    id: 8,
    variable: "product_list_price",
    type: "UDO Variable",
    destination: "ADD_CART.price",
    destColor: "orange",
  },
];
...
const DEST_COLOR_MAP = {
  ...
  orange: { line: "bg-blue-400", badge: "bg-orange-300/30 text-black-700" },
};
  ...
  return (
    <div className="px-6 py-5">
      <InfoBox color="red">
        ...
        <span className="text-blue-600 font-semibold">azul</span>, dirigirse al
        apartado <strong>Event-specific parameters</strong> e introducir el
        nombre de la variable exactamente como figura en la documentación
        oficial.
        <br />
        <br />
        Para el mapeo del evento color{" "}
        <span className="text-orange-400 font-semibold">naranja</span>, seguir
        la ruta: <strong>Add mapping → Events</strong>
      </InfoBox>
            ...
            {vars.map((v) => (
              ...
              >
                ...
                <td className="px-4 py-2.5">
                  {(() => {
                    const colors =
                      DEST_COLOR_MAP[v.destColor] ?? DEST_COLOR_MAP.blue;
                    return (
                      <div className="flex items-center gap-2">
      ...
      <div className="w-full rounded-xl overflow-hidden">
        ...
        <div className="flex border-b border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900">
          {TABS.map((tab) => {
            ...
            const isDone =
              tab.id === "configuration" && activeTab !== "configuration";
            return (
              <button
                key={tab.id}
