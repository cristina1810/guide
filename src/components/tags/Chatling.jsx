...
import ChatlingMapping from "./ChatlingMapping";
  ...
  return (
    <div className="flex flex-col">
      <div className="mx-4 mt-4">
        <InfoBox className="" color="blue">
          Usamos la Load Rule que hemos creado
        </InfoBox>
      </div>
      {/* ── Main row ── */}
...
function ConfigurationTab() {
  ...
  return (
    <div className="px-6 py-5">
      ...
      <Field label="Type">
        <SelectField value={"Script"} options={["Chatling"]} className="w-64" />
        <Helper>Most pixels are Image pixels (default)</Helper>
      </Field>
      ...
      <Field label="Query String">
        ...
        <Helper>
          ...
          added here instead of using mapping)
        </Helper>
      </Field>

      <Field label="Auto Cache Bust">
        <SelectField value={"Disable"} options={["Disable"]} className="w-36" />
        <Helper>
          Enable this feature for cache busting. When enabled, the cache buster
          param is added to the pixel so the browser will not cache the tracking
          pixel request.
        </Helper>
      </Field>
      <Field label="Cache Bust Name">
        ...
        <Helper>
          ...
          Bust is enabled and this field is left blank, the default value of
          "_rnd" will be used.
        </Helper>
      </Field>
      <Field label="Request Script Once">
        <SelectField
          value={genEventId}
          options={["Disable"]}
          className="w-36"
        />
        <Helper>
          Works only with "Script" Type. Enable this feature to request the base
          script only once. When enabled, the script will be requested once per
          page load and all subsequent virtual calls will go straight to the
          callback.
        </Helper>
      </Field>
      ...
      <Field label="Tag Timing">
        ...
        <Helper>
          ...
          immediately on page loads. DOM Ready tags wait to fire until the page
          HTML has been completely loaded by the browser.
        </Helper>
      </Field>
...
const VARS_DATA = [
  {
    ...
    type: "2367823816",
    destination: "attribute.data-id",
    destColor: "blue",
  },
  {
    id: 2,
    variable: "Custom Value",
    type: "chatling-embed-script",
